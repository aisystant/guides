...
concepts:
  ...
  - инженерия систем создания
---

# 7.3. Взаимосвязь инженерии, менеджмента и предпринимательства
...
3. **Инженерией организации** и всем, что с ней связано, занимается менеджер. Менеджер организует производство, он обеспечивает воплощение идей предпринимателя и моделей инженера в реальности. Он создает предприятие, которое эффективно производит целевую систему (или налаживает выпуск многих систем), будь то автомобили, прически или жизненное мастерство. Менеджер также отвечает за масштабируемость и устойчивость работы предприятия.
