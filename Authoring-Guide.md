...
|------|--------|-----------|
| 2026-04-08 | v0.2 | В `AG.3:3` добавлены правила оформления сносок, включая многострочные сноски; уточнено, что сноски уникальны в пределах файла и располагаются в конце файла; добавлен журнал изменений документа; В `AG.2:8` для чеклистов добавлен алиас `Check` в табельных номерах |
